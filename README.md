...
- site.whatsblog.service

- site.whatsblog.controller
...
### 4、编写数据库对应的实体类 site.whatsblog.pojo.Books
...
<mapper namespace="site.whatsblog.dao.BookMapper">
...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <bean id="BookServiceImpl" class="site.whatsblog.service.BookServiceImpl">
...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <!-- 4.扫描web相关的bean -->
   <context:component-scan base-package="site.whatsblog.controller" />
